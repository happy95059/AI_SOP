...
RTSP_URL = "rtsp://admin:50984878@192.168.0.205:10554/tcp/av0_0"
# RTSP_URL = "rtsp://admin:50984878@192.168.0.205:10554/udp/av0_0"
# RTSP_URL = "rtsp://admin:Sat@50984878@192.168.0.89:554/live1s1.sdp"

FONT = cv2.FONT_HERSHEY_SIMPLEX


def parse_args():
    parser = argparse.ArgumentParser(description="產線工作站影像識別（YOLO 手部附近物體輪廓）")
    parser.add_argument(
        "--url",
        type=str,
        default=RTSP_URL,
        help="IPCAM 的 RTSP 網址（預設使用 main_YOLO.py 內 RTSP_URL）",
    )
    parser.add_argument(
        "--pose",
        action="store_true",
    ...
    with mp_hands.Hands(
        ...
        while True:
            ...
            if not args.no_display:
                cv2.imshow("TH_IPCAM_DEMO - Pose & Hands & YOLO Near Contours", display_frame)
